      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Your intelligent shopping companion. Create lists, discover recipes,
            and make grocery shopping effortless.
          </p>
      ...
      <section className="py-20 px-4 bg-white/50 dark:bg-gray-800/50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 text-center mb-12 max-w-2xl mx-auto">
            Sauda Talika combines the simplicity of list-making with the power
            of AI to transform how you plan your meals and shopping.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="border-orange-200 dark:border-gray-600 hover:shadow-lg transition-shadow duration-300 bg-white/80 dark:bg-gray-800/80"
              >
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of users who have made their grocery shopping smarter
            and more efficient with Sauda Talika.
          </p>
          <Button
            size="lg"
            onClick={() => navigate("/dashboard")}
